...
from clustered_push_relabel.clustering.simple_three_level_l1 import (
    ThreeLevelL1Clustering,
)
...
def benchmark_three_level_l1(P_red, P_blue, device):
    for _ in range(WARMUP_RUNS):
        ...
        solver = ThreeLevelGPUSolver(
            ...
            verbose=False,
            clustering_class=ThreeLevelL1Clustering,
        )
...
def run_three_level(P_red, P_blue, device):
    try:
        time_ms, cost, iterations = benchmark_three_level_l1(P_red, P_blue, device)
...
def print_results_table(rows):
    ...
    headers = [
        ...
        ("ThreeLevel Avg L1 Cost", col_widths["three_level_cost"], ">"),
