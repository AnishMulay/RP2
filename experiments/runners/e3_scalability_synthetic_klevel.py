...
def main():
    parser = argparse.ArgumentParser(description="E3 Scalability Synthetic (k-Level only)")
    ...
    parser.add_argument("--csv", type=str, default="results_e3_scaling_klevel.csv")
    ...
    for n in n_list:
        ...
        try:
            ...
            t0 = time.time()
            solverK = KLevelSolver(P_red, P_blue, args.epsilon, k=args.k, batch_size=args.batch_size)
