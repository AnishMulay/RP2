#!/bin/bash
#SBATCH -J synth_n150000
#SBATCH -o scale_batch/logs/synth_n150000-%j.out
#SBATCH -e scale_batch/logs/synth_n150000-%j.err
#SBATCH -N 1
#SBATCH -n 1
...
echo "Starting Job for N=150000 (10 Trials)"
...
do
    ...
    python -u e3_scalability_synthetic.py \
      ...
      --k 4 \
      --seed $CURRENT_SEED \
      --csv scale_batch/results/results_n150000.csv
done

echo "Job N=150000 Complete"
