#!/bin/bash
#SBATCH -J synth_n800000
#SBATCH -o scale_batch/logs/synth_n800000-%j.out
#SBATCH -e scale_batch/logs/synth_n800000-%j.err
#SBATCH -N 1
#SBATCH -n 1
...
echo "Starting Job for N=800000 (10 Trials)"
...
do
    ...
    python -u e3_scalability_synthetic.py \
      ...
      --k 4 \
      --seed $CURRENT_SEED \
      --csv scale_batch/results/results_n800000.csv
done

echo "Job N=800000 Complete"
