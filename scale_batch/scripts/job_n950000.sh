#!/bin/bash
#SBATCH -J synth_n950000
#SBATCH -o scale_batch/logs/synth_n950000-%j.out
#SBATCH -e scale_batch/logs/synth_n950000-%j.err
#SBATCH -N 1
#SBATCH -n 1
...
echo "Starting Job for N=950000 (10 Trials)"
...
do
    ...
    python -u e3_scalability_synthetic.py \
      ...
      --k 4 \
      --seed $CURRENT_SEED \
      --csv scale_batch/results/results_n950000.csv
done

echo "Job N=950000 Complete"
